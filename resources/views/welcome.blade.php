<x-guest-layout>
    ...
    @if($banners->isNotEmpty())
        @foreach($banners as $banner)
            <div class="p-5">
                <img src="{{asset('storage/'.$banner->image->url)}}"  class="flex-none w-full max-h-50" alt="">
            ...
            <div
                ...
                <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
                    ...
                    <a href="{{route('register')}}"
                       class="flex-none rounded-full bg-{{$banner->color}}-900 px-3.5 py-1 text-sm font-semibold text-black shadow-sm hover:bg-{{$banner->color}}-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900">Register
